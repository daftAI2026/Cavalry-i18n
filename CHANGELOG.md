...
- **Recompiled Injector Dylib**: Recompiled and updated the universal binary `injector/libCavalryTranslatorInjector.dylib` to embed the synchronous QDialog/ModalDialog pre-paint translation engine.
