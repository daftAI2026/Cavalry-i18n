...
### Added
- **Update Availability Surface**: Added a four-language update icon, tooltip, screen-reader announcement, confirmation dialog, and macOS new-bundle ad-hoc/Gatekeeper reminder. The user-supplied arrow renders at 20px inside a 24px circular action only for an explicit local preview or a signed updater result.
