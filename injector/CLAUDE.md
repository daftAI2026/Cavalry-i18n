...
cavalry_i18n_translation_policy.h: 跨平台 source-only 查询边界；把 CogTool 动态 Pitch、Color Settings/Mesh Explorer 模板与单索引占位文字限制在精确 context，禁止专用词条泄漏到普通 QWidget 或用户文本。
