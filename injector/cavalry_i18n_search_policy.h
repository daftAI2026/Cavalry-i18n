/**
 * [INPUT]: 依赖 cavalry_i18n_quick_add_context.h 的 exact owner/搜索框 guard、Qt 6 QIdentityProxyModel/QSortFilterProxyModel、FastQuickAddModel 的 role 0/256/257，以及注入方提供的当前语言别名查询函数
