/**
 * [INPUT]: 依赖已验证并 process-lifetime PIN 的 CavalrySkiaRuntimeAbi、语言标签、受控 UTF-8 译文集合与 Windows 系统 CJK 字体
 * [OUTPUT]: 对外提供经全量字形覆盖验证的 CJK Skia Path 工厂；任一 ABI、字体或空轮廓异常均返回失败供调用方回退英文
