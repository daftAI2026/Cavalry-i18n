...
| W2 generic plugin | 已实现 | Qt 6.6.3 x64 MSVC 编译、8 项 CTest、Tauri resource 与 NSIS 构建；四条 ExtensionLayer 边界均有 ABI 合同，Pencil/Pen/Centre 动作、selected QLabel 与动态 Pitch 生产/消费链有真实 vendor 合同，且无第二套 Qt runtime | 真实 Cavalry 的三语首帧、动态菜单、Pencil/Pen/Centre 整行、Pencil 警告、Pitch bit 22 与显示白名单截图 |
