...
windows-port-and-injection-roadmap.md: Active 的 Windows 移植路线，规定任意安装根 JSON keyed overlay、Qt generic translator + QPA delegate 原生入口汇合、显式 English/卸载恢复、含动态 Pitch caller/source 门的受限 ExtensionLayer IAT hook、权限边界、marker 事务与真机验收。
