...
- `node --test docs/workflows/cavalry-full-ui-100/tests/extraction-inventory-contract.test.js`
- `node --test docs/workflows/cavalry-full-ui-100/tests/capture-accessibility-contract.test.js`
