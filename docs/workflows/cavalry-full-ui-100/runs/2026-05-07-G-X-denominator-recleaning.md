...
filter source              docs/workflows/cavalry-full-ui-100/Anti-Patterns.md §F
...
```text
node --test docs/workflows/cavalry-full-ui-100/tests/extraction-inventory-contract.test.js tools/check_electron_patcher_ui.js
PASS: 79/79
```
