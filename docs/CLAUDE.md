...
cavalry-runtime-injection-techniques.md: Cavalry runtime UI 抽取与翻译注入技术沉淀，记录 QTranslator 子类化 / DYLD 注入 / ad-hoc 重签 / dump-only 抽取，以及 QMenu/QLineEdit/QDialog/QTextEdit MessageBar/QStatusBar 首次绘制前翻译的为什么这么做。
