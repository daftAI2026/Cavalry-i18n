...
macos-app-management-lifecycle-lessons-2026-08-31.md: macOS App Management 生命周期与签名副作用复盘；以具体 TCC service 和系统 Quit & Reopen 证据冻结 fresh-session，并证明首次 handoff 必须早于 Cavalry mutation、三个脚本入口外置签名组件必须纳入 journal/官方恢复且只能在精确旧残留证据下清理。
