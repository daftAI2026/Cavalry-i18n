...
> 排查依据：`docs/runtime-translation-noise-triage.md`
...
### 组 A：`docs/runtime-translation-noise-triage.md` 指名的 5 个核心可疑 token
...
对照 `docs/runtime-translation-noise-triage.md` 证据等级定义：
