...
- `docs/workflows/cavalry-full-ui-100/Runbook.md` 已规定：任何 Cavalry version / Qt version / bundle hash 变化都触发 denominator drift。
...
- `docs/workflows/cavalry-full-ui-100/runs/2026-05-14-cavalry-2.7.2-target-refresh.md`
...
- Create: `docs/workflows/cavalry-full-ui-100/runs/2026-05-14-cavalry-2.7.2-target-refresh.md`
...
```bash
rg -n "^## Status$|^PASS$|2\.7\.2|2\.7\.1" docs/workflows/cavalry-full-ui-100/runs/2026-05-14-cavalry-2.7.2-target-refresh.md
```
...
```bash
git add docs/workflows/cavalry-full-ui-100/runs/2026-05-14-cavalry-2.7.2-target-refresh.md
...
Read `docs/workflows/cavalry-full-ui-100/runs/2026-05-08-ALL-GATES-PASS.md`，找到其中记录的 `SESSION_DIR`。

Run:

```bash
rg -n "SESSION_DIR|target|extraction|full-ui-run-record" docs/workflows/cavalry-full-ui-100/runs/2026-05-08-ALL-GATES-PASS.md
```
...
- Modify: `docs/workflows/cavalry-full-ui-100/Project.md` if gate state changes
- Modify: `docs/workflows/cavalry-full-ui-100/TODO.md` if task state changes
- Modify: `docs/workflows/cavalry-full-ui-100/Acceptance.md` only when evidence satisfies acceptance
- Create: `docs/workflows/cavalry-full-ui-100/runs/YYYY-MM-DD-2.7.2-full-ui-result.md`
...
Create `docs/workflows/cavalry-full-ui-100/runs/YYYY-MM-DD-2.7.2-full-ui-result.md` with:
...
```bash
git add docs/workflows/cavalry-full-ui-100/Project.md docs/workflows/cavalry-full-ui-100/TODO.md docs/workflows/cavalry-full-ui-100/Acceptance.md docs/workflows/cavalry-full-ui-100/runs
...
- Type/path consistency: Paths match current repository structure: `tools/`, `languages/`, `injector/`, and `docs/workflows/cavalry-full-ui-100/`.
