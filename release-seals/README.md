...
[OUTPUT]: 说明 source commit S、evidence commit T、外部 detached acceptance signer、独立双 trust anchor、tag 与 schema v5 CI asset seal 的不可自引用绑定
