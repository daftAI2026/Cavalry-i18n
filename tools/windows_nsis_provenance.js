#!/usr/bin/env node
/**
 * [INPUT]: 依赖 windows_nsis_provenance_contract.js、renderer/languages、Windows Tauri/Rust/NSIS/updater overlay、package manifests、共享 translation/input/Quick Add context/search/Classic/Quick Add 描述 policy 与生成输入、已编译 generic/QPA 与显式 x64 NSIS 输出
