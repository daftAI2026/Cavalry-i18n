...
check_dmg_layout.sh: DMG 身份、布局与签名守门器，挂载真实 `.dmg` 并验证版本/架构卷标、`.DS_Store`、背景图、卷宗图标、custom-icon 标记、Applications 链接、DMG 内 app 与安装态 app 的 bundle seal/codesign strict 结果。
