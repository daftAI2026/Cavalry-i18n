...
check_renderer_contract.js: Renderer 静态合同，冻结 local-only 系统字体、16/14/13px 与 400/450/500 排印角色、4px spacing token、DOM/API 锚点、macOS 原生交通灯与 Windows 无 caption/右侧控件边界、Item/Select/About/Button Group/任务视窗/AlertDialog 的 Grid/Flex 职责、单一语义图标注册表、idle 居中、首尾 Message/中段 Marker、Spinner/shimmer/8px scroll-fade/live-edge、真实事件可读节奏/错误抢占与阶段图标边界、语言身份与安装状态正交双徽章、更新/About tooltip、固定项目外链与 400×480 capability。
