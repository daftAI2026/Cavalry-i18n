...
# [OUTPUT]: 校验版本/架构卷标、背景图、.DS_Store、卷宗图标、Applications 链接、app bundle、安装态 app 与 bundle seal
# [POS]: tools/ 下的 DMG 身份、布局与签名守门器，阻止本地或 CI 发布身份模糊、未美化或被 Gatekeeper 判定 damaged 的安装镜像
