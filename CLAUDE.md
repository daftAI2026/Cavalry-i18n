...
tools/ - 自动化工具链，涵盖翻译提取、校验、SDK 解析、Windows NSIS 安装态与精确 PID/HWND 证据，以及 tracked macOS Objective-C++/CGWindow 21-run/48-point 定向验收器；原生库和 live session 现场生成而不入库 (Node.js, PowerShell, Bash, Objective-C++, Swift)
