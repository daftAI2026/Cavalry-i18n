 ...
 * [OUTPUT]: 冻结最小 window.cavalryI18n API；仅转发 camelCase payload（含 macOS 官方/受管安装态、Windows reconciliationRequired 与可组合 warningCodes），丢弃 raw warning prose，并将 transport rejection 归一为 Error。
