...
成员清单
index.html: 跨平台语义 DOM 骨架，承载原生标题区、安装 Item、全宽 Select、等宽 Switch/Restore、三轨 Activity、必要 AlertDialog，并加载共享 Toast；About 内容由独立本地页面承载。
...
app.js: 唯一业务交互源；持久任务进入 Activity，Restore/更新/权限进入 AlertDialog，About 唤起失败进入 Toast。保持直接 Switch、统一 Restore、Updater 与 fail-closed 门禁。
