...
tokens.css: 离线设计角色唯一真相源；16/14/13px、400/450/500 与 4px 节奏覆盖窗口/控件/Activity/Toast/AlertDialog，About 标识由 64px 基准加一个 4px 档得到 68px。语言 blue-subtle 与 Official green-subtle 使用透明边界，基础灰色可保留描边；Toast 保留 shadcn 16px inset 并与 20px 主网格错层。
