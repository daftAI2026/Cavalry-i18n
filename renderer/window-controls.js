/**
 * [INPUT]: 依赖 index.html 的 Windows caption controls、冻结 cavalryI18n 窗口 API 与 app.js 提供的本地化函数
 * [OUTPUT]: 对外提供 createWindowControls；仅在 Windows 显示右侧最小化、最大化/还原、关闭，并同步最大化图标与可访问名称
 * [POS]: renderer 的平台窗口状态机；隔离原生窗口生命周期与业务交互，macOS 保持 AppKit 原生交通灯路径
 * [PROTOCOL]: 变更时更新此头部，然后检查 CLAUDE.md
 */
(() => {
  function createWindowControls({ api, text }) {
