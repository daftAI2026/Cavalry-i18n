...
const UI_TEXT = {
  en: {
    ...
    apply: 'Switch',
    updateLanguagePatch: 'Update language patch',
    ...
    patchUpdateBadge: 'Update available',
    languageOptionUpdateAria: '{language}, Update available',
    retry: 'Retry',
  ...
  'zh-Hans': {
    ...
    chooseLanguage: '选择语言',
    apply: '切换',
    updateLanguagePatch: '更新语言补丁',
    restore: '恢复英文',
    officialMode: '安装状态：已验证的官方运行时',
    modifiedMode: '安装状态：已在本机修改',
    recoveryMode: '安装状态：必须先完成中断事务恢复',
    officialBadge: '官方',
    patchUpdateBadge: '可更新',
    languageOptionUpdateAria: '{language}，可更新',
    retry: '重试',
    openSettings: '打开设置',
