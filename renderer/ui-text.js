...
const UI_TEXT = {
  en: {
    ...
    reinstallRequired: 'The Switcher can’t verify the original English files needed for recovery. Reinstall Cavalry from the official installer, then reopen the Switcher.',
  ...
  'zh-Hans': {
    ...
    reinstallRequired: '语言切换器无法验证恢复所需的原始英文文件。请使用官方安装包重新安装 Cavalry，再重新打开语言切换器。',
  ...
  'zh-Hant': {
    ...
    reinstallRequired: '語言切換器無法驗證復原所需的原始英文檔案。請使用官方安裝程式重新安裝 Cavalry，再重新開啟語言切換器。',
  ...
  ja_JP: {
    ...
    reinstallRequired: '復元に必要な元の英語ファイルを確認できません。公式インストーラーで Cavalry を再インストールしてから、言語スイッチャーを開き直してください。',
