 ...
 * [OUTPUT]: 对外提供跨平台单任务流、渐进安装选择、版本只读门禁、三轨 Activity、语言/Official Badge、直接 Switch、证据分级的单一 Restore English、保留阻断前历史且折叠同进程 oracle 重复前置成功阶段的 macOS 设置/Windows UAC 分流、App Management 仍拒绝后的明确重开提示、Updater 与外围失败 Toast。
