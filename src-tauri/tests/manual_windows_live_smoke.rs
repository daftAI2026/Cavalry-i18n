/**
 * [INPUT]: 依赖显式 disposable clone/evidence 环境变量、共享 Windows 路径守卫、owned clone profile、apply_language_inner、RealCommandRunner、runtime marker、Onboarding/Adjacent ready/ack 状态机与 PowerShell exact-HWND helper
