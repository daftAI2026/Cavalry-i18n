 ...
 * [OUTPUT]: 保持 privilege::{CommandRunner, RecordingRunner, RealCommandRunner, CopyOutcome,...} 兼容入口，提供 typed 写入前 graceful close、Windows 提升 worker 早期分流，并向 crate 内提供无控制台 captured command。
