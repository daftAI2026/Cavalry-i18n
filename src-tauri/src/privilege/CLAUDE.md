...
macos/: macOS durable apply transaction、bundle 维护与 exact-PID 适配器；承担 fd-bound copy/restore、首次 launch gate、codesign、quarantine 与 Privacy & Security 入口；签名证据覆盖 vendor/ad-hoc requirement，并把脚本入口重签产生的三个外置组件纳入精确残留分类、签名 side-effect journal 与官方恢复范围。
