...
rg -n '<source>Rhu</source>|\bRhu\b|鲁' \
  tools injector languages doc output
```
...
1. 在 `doc/cavalry-glossary.md` 或 `doc/translation-guidelines.md` 有规则。
...
```text
请按 doc/runtime-translation-noise-triage.md 排查以下可疑 runtime 翻译：
