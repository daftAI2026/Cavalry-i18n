...
doc/compiled-menu-contexts.json                # compiled menu 字符串清单
doc/cavalry-menu-localization-feasibility.md   # QM 可行性研究
...
| `doc/cavalry-scripting-*` | 逆向工程参考文档，留着有价值 |
| `doc/plan-v3.md` | 历史记录，可归档 |
...
rm doc/compiled-menu-contexts.json
rm doc/cavalry-menu-localization-feasibility.md
