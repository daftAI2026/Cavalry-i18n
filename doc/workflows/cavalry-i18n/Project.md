<!--
[INPUT]: 依赖 doc/plan-v3.md 的技术方案、doc/translation-guidelines.md 的翻译原则、doc/cavalry-glossary-en-zh.md 的术语表
...
WORKFLOW = REPO/doc/workflows/cavalry-i18n
```
...
| 任务 | 允许修改的文件 |
|---|---|
| T0 | `doc/cavalry-glossary.md` |
| T1 | `tools/extract_strings.py`, `languages/en/**` |
| T1.1 | `doc/translation-whitelist.json` |
...
```
doc/plan-v3.md                           — 技术方案（架构、API、切换逻辑）
doc/translation-guidelines.md            — 翻译原则（术语对齐、简繁差异）
doc/cavalry-glossary-en-zh.md            — 初始术语表（en→zh-Hans，78 条）
...
| 领域 | 真相源 | 说明 |
|---|---|---|
| 翻译术语 | `doc/cavalry-glossary.md`（四语言版，T0 产出） | 所有翻译必须严格匹配 |
| 翻译范围 | `doc/translation-whitelist.json`（T1.1 产出） | 定义哪些字段翻译/不翻译 |
| 英文原文 | `languages/en/`（T1 产出） | 翻译的源文件 |
| 工具行为 | `doc/plan-v3.md` | LanguageSwitcher.js 的功能规格 |
| 翻译原则 | `doc/translation-guidelines.md` | 跨语言的翻译约束 |
