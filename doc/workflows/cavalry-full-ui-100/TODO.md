...
- jsonTotal = 6294（不再复用 6415）
- compiledCandidates = 3274（不再复用 4919/5195）
- runtimeCandidates / runtimeMenuLeaves = 619 / 733（不再复用 626/734）
新分母即新真相源，旧分母只作历史。
...
| G-X | PASS | runs/2026-05-07-G-X-denominator-recleaning.md；新分母 JSON 6294 / compiled 3274 / runtime 619 / menuLeaves 733 |
