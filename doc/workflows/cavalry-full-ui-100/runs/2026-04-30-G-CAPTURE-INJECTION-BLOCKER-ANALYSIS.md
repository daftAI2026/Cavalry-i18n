...
Per `doc/cavalry-runtime-injection-techniques.md`:
...
- `doc/cavalry-runtime-injection-techniques.md` - Technical foundation
- `doc/workflows/cavalry-full-ui-100/Acceptance.md` §G-CAPTURE - Pass conditions
- `doc/workflows/cavalry-full-ui-100/Anti-Patterns.md` §D SIP-Blame - What NOT to claim
