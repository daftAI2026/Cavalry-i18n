<!--
[INPUT]: 依赖 cavalry-full-ui-100/ 所有入口文档 + doc/ 翻译准则
...
8. `REPO/doc/translation-guidelines.md` — 翻译原则：术语对齐、零混合语言、简繁差异
9. `REPO/doc/cavalry-glossary.md` — 四语言术语表（en/zh-Hans/zh-Hant/ja_JP，~50 条）
10. `REPO/doc/cavalry-glossary-en-zh.md` — 英简中双语术语表（带翻译决策注释）
