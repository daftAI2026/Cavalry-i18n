...
6. 不修 Electron build / electron-builder / Electron harness；旧断言只迁移到 Tauri / full-ui gate
...
若失败点只来自 Electron 专属 build / harness，不在本 prompt 内修旧壳；迁移仍有价值的断言，CI 打包只收敛到 Tauri SOP。
