...
- JSON lower bounds 达到 G-X 清洗后 `10 / 6199 / 34 / 51 / total 6294`
- compiled source-map entries `>= 3274`（Cavalry 2.7.1 raw extraction 经 §F 噪声剔除；2.7.0 时为 4743）
- runtime candidates `>= 619` 且 menu leaves `>= 733`，下界来自 1D78B1A9 清洗后合格基线
