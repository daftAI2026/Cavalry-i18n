...
[POS]: doc/ 方案文档，承接 runtime UI 注入覆盖修复，不驱动运行时
...
- `tools/check_runtime_ui_coverage.js`
- `doc/cavalry-runtime-injection-techniques.md`
...
```bash
git add tools/check_app_contracts.js doc/runtime-ui-injection-coverage-plan.md
